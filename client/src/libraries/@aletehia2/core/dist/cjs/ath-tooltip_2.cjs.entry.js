...
const AthTooltip = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'fcf26ea0d30845fed490abc175efbf28e609aed6' }, index.h("div", { key: 'b231769ea13b73ee44f0f41e436731c8ff283c6e', class: "ath-tooltip-container" }, index.h("slot", { key: '4b607cd8184146c029339504ad28c53cc41630a5' }), this.headingText !== '' && (index.h("span", { key: '9081aa38bf233bdcf10e2c15760061ffb88654d6', id: this.tooltipId, role: "tooltip", class: this.classNames(), style: {
...
const TooltipTrigger = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'cc6a8bb7d8a665c2c6f4526884e08461d16e2e35', role: "button", class: this.getHostClassNames(), onFocus: this.handleFocus, onBlur: this.handleBlur, onClick: this.handleClick, "aria-label": this.el.ariaLabel ?? this.ariaLabel, tabIndex: hostTabindex }, index.h("ath-icon", { key: 'a586e4637e5a725df27a2a23fb94d1ec7c0a013f', icon: this.icon, size: this.size })));
    }
};
TooltipTrigger.style = tooltipCss;

exports.ath_tooltip = AthTooltip;
exports.ath_tooltip_trigger = TooltipTrigger;
//# sourceMappingURL=ath-tooltip.ath-tooltip-trigger.entry.cjs.js.map
