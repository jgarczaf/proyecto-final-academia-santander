...
const AthAlert = class {
    ...
    renderIcon = () => {
        return index.h("ath-icon", { size: "md", icon: this.getIcon(), color: "inherit" });
    };
    getIconColor = () => {
    ...
    renderCloseButton = () => {
        return (index.h(fcButtonComp.FcButtonComp, { icon: "close_small", color: this.getIconColor(), iconPosition: button_model.ButtonIconPosition.IconOnly, size: icons.IconSize.Extrasmall, onClick: this.closeAlert, buttonAriaLabel: this.closeAriaLabel }));
    };
    renderDivIcon = () => {
        return index.h("div", { class: "ath-alert__icon" }, this.renderIcon());
    };
    renderDivCloseButton = () => {
        return index.h("div", { class: "ath-alert__close" }, this.renderCloseButton());
    };
    renderDivTitle = () => {
        const HeadingTitle = heading.getHeading(this.headingLevel);
        return (index.h(HeadingTitle, { class: "ath-alert__title", id: this.titleId }, this.headingText));
    };
    renderDivDescription = () => {
        return (index.h("div", { class: "ath-alert__description", id: this.descriptionId }, this.description));
    };
    componentDidLoad() {
    ...
    renderSection = () => (index.h("div", { class: "ath-alert__container" }, index.h("div", { class: this.getClassNames() }, index.h("div", { class: "ath-alert__content" }, this.renderDivIcon(), index.h("div", { class: "ath-alert__wrapper" }, this.headingText && this.renderDivTitle(), this.description && this.renderDivDescription(), index.h("slot", null)), this.hasClose && this.renderDivCloseButton()), this.hasButtonSlotElements && index.h("slot", { name: "button" }))));
    renderPage = () => (index.h("div", { class: "ath-alert__container" }, index.h("div", { class: this.getClassNames() }, this.renderDivIcon(), index.h("div", { class: "ath-alert__wrapper" }, index.h("div", { class: "ath-alert__frame" }, this.headingText && this.renderDivTitle(), this.description && this.renderDivDescription(), index.h("slot", null)), this.hasButtonSlotElements && (index.h("div", { class: "ath-alert__button" }, index.h("slot", { name: "button" })))), this.hasClose && this.renderDivCloseButton())));
    componentWillLoad() {
    ...
    render() {
        if (this.type === 'section') {
            return index.h(index.Host, { ...this.getAttributes() }, this.isVisible && this.renderSection());
        }
        else {
            return index.h(index.Host, { ...this.getAttributes() }, this.isVisible && this.renderPage());
        }
    }
...
exports.ath_alert = AthAlert;
//# sourceMappingURL=ath-alert.entry.cjs.js.map
