...
const AthAvatar = class {
     ...
     * Size of the avatar.
     */
    size = avatar_model.AvatarSizes.Medium;
    /**
    ...
    getInitials = () => {
        if (this.initials) {
            ...
            return index.h("span", { class: "ath-avatar--initials" }, this.initials.toUpperCase().slice(0, 2));
        }
            ...
            const initials = this.avatarName
                ...
                .slice(0, 2)
                .join('');
            return index.h("span", { class: "ath-avatar--initials" }, initials);
        }
        return null;
    };
    renderContent = () => {
        // If type is defined and is image, Check for image
        if (this.type === avatar_model.AvatarTypes.Image && this.hasImage()) {
            this.avatarClassType = 'image';
            return index.h("slot", { name: "img" });
        }
        // If type is defined and is initials, check for initials
        if (this.type === avatar_model.AvatarTypes.Initials) {
    ...
    renderDefaultImg = () => {
        ...
        return (index.h("svg", { focusable: "false", "aria-hidden": "true", viewBox: "0 0 32 32" }, index.h("use", { xlinkHref: `${assetsPath}illu_male.svg` })));
    };
    hasAriaLabel() {
    ...
    render() {
        return (index.h(index.Host, { key: 'a461eacaa264acc2d073916de2261053259c3479', ...this.getHostAttributes() }, index.h("div", { key: '59a5693d40e4c848c371acd05b125c660aaa9097', class: this.getClassNames() }, this.renderContent())));
    }
};
...
const AthButtonLink = class {
    ...
    renderIcon = () => {
        const iconSize = icons.transformIconSize(icons.IconType.ButtonLink, this.size);
        return index.h("ath-icon", { icon: this.icon, color: "inherit", size: iconSize });
    };
    render() {
        const hostTabindex = this.el.getAttribute('tabindex') === '-1' ? '-1' : '0';
        return (index.h(index.Host, { key: '0198f0b8c0d485c210f878994ddd42b8385bc024', role: "button", class: this.getHostClassNames(), tabindex: this.disabled ? '-1' : hostTabindex, onFocus: this.handleFocus, onBlur: this.handleBlur, onClick: this.handleClick, "aria-disabled": this.disabled ? 'true' : 'false' }, index.h("span", { key: 'f8dc664dbda30fa37e65db2d0047b2758d6b5974', class: this.getSpanClassNames(), part: "button-link-styles" }, index.h("span", { key: '3baf1047389aa42b71e0e453b9222f37bb56b408', class: "ath-button-link__inner" }, this.icon && this.iconPosition === ButtonLinkPosition.Left && this.renderIcon(), index.h("slot", { key: 'b23b89609695c86b96e1b82ff9c37d0002e66a73' }), this.icon && this.iconPosition === ButtonLinkPosition.Right && this.renderIcon()))));
    }
};
AthButtonLink.style = buttonLinkCss;

exports.ath_avatar = AthAvatar;
exports.ath_button_link = AthButtonLink;
//# sourceMappingURL=ath-avatar.ath-button-link.entry.cjs.js.map
