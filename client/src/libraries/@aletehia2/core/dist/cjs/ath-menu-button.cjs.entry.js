...
const AthMenuButton = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '0a9a0494d967dbb6246610c8b777d73b0c33d0cb' }, index.h("div", { key: '92b4aca13fe8777363003ebe1ef3fae47c7577b6', class: "ath-menu-button-container" }, index.h("div", { key: '615a3b48960031510834929c54e8c08114340c3e' }, index.h("ath-button", { key: 'a6857ff552e75e65b045265326cec90d897b0656', id: "button-menu", autofocus: !!this.autofocus, icon: this.icon, "icon-position": "icon-only", clear: this.clear, color: this.color, disabled: this.disabled, size: this.size, onAthClick: this.handleClick, "aria-controls": this.overlayId, "aria-expanded": !!this.open ? 'true' : 'false', "aria-haspopup": "true", class: this.getButtonClassNames(), "aria-label": this.athAriaLabel })), this.open && !this.disabled && (index.h("div", { key: '52a7974a390eefe8b92ad5757ee678673df56e1f', style: styleHeight, class: this.getOverlayClassNames(), id: this.overlayId, role: "menu", tabindex: "-1" }, index.h("div", { key: '868e41290b06bbd370dea4b52813a5be939ebe81', class: "ath-scroll ath-menu-button-overlay-wrapper" }, index.h("slot", { key: '2a3ef70d33fa5de66239b6517290b0a0bc56c15e' })))))));
    }
};
AthMenuButton.style = menuButtonCss;

exports.ath_menu_button = AthMenuButton;
//# sourceMappingURL=ath-menu-button.entry.cjs.js.map
