...
const AthCardSelectable = class {
    ...
    renderIcon = () => {
        ...
        return index.h("ath-icon", { icon: icon, size: size, color: "inherit" });
    };
    render() {
        const tagColor = this.disabled ? 'disabled' : 'primary';
        return (index.h(index.Host, { key: '6d08a21002df084479058f8d93e45628a9329ed9', ...this.getHostAttributes(), ...this.getAriaAttributes() }, index.h("div", { key: 'd35fab7d32784832d7cadcf5df6b9d0c917c83cd', class: this.getCardClassNames() }, index.h("div", { key: '3fa24bf7b6c7776bb2d8fa23173f87181cb973b9', class: "ath-card-selectable_content" }, index.h("div", { key: '1d523271e83617df2ea4df86aace6ad74dace95d', class: "ath-card-selectable_header" }, index.h("div", { key: '749d37e6fdf65dd5a383c0eb766ae425467b90b4', class: "ath-card-selectable_headlines" }, !!this.tag && index.h("ath-tag", { key: '2760783944a8b7f36a262ca62721c1f5914e0814', id: this.tagId, size: "md", color: tagColor, headingText: this.tag }), !!this.overline && index.h("span", { key: '82d68ede238a760609d0e254d19c8aa337f1a90f', class: "ath-card-selectable_overline" }, this.overline), index.h("div", { key: '3662695148d2a6bc0f516ef4bd6202d026682131', class: "ath-card-selectable_wrapper" }, index.h("span", { key: '410680a9f1d9a8344cc5f6faeb9576f1e8d4e093', id: this.headlineId, class: "ath-card-selectable_headline" }, this.headingText), index.h("span", { key: '2a68821556b97af93d03aae8c3ff24417ec8e1c4', id: this.subheadlineId, class: "ath-card-selectable_subheadline" }, this.subtitle))), index.h("div", { key: '8654bef79dc43de589e67e0566e2b23ccf6df3be', class: this.getCheckClassNames() }, this.selected && this.renderIcon())), index.h("slot", { key: 'b3cd6aaf85513675066ed13264ab44de8f4a1ce6', name: "body" })))));
    }
};
AthCardSelectable.style = cardSelectableCss;

exports.ath_card_selectable = AthCardSelectable;
//# sourceMappingURL=ath-card-selectable.entry.cjs.js.map
