...
const AthInputPassword = class {
    ...
    renderInput = () => {
        ...
        return (index.h("div", { class: "ath-input" }, !!this.label && index.h(fcLabel.FcInputLabel, { ...labelProps }), index.h("div", { class: "wrapper" }, index.h(fcInputElement.FcInputElement, { ...inputProps }), this.counter && index.h(fcCounter.FcInputCounter, { ...counterProps }), !!this.helperText && index.h(fcHelper.FcInputHelperText, { ...helperTextProps }), this.feedback !== InputFeedbackTypes.None && !this.disabled && !this.readonly && index.h(fcHelper.FcInputFeedback, { ...feedbackProps }))));
    };
    render() {
        return index.h(index.Host, { key: 'cd3ba9c26ba545247ca7f840dc643edd44eccef3' }, this.renderInput());
    }
...
exports.ath_input_password = AthInputPassword;
//# sourceMappingURL=ath-input-password.entry.cjs.js.map
