...
const AthCheckBox = class {
     ...
     */
    value = checkbox_model.CheckboxValue.False;
    /**
     ...
     * Type of feedback
     */
    feedback = checkbox_model.FeedbackType.None;
    /**
    ...
    toggleChecked() {
        this.value = this.value === checkbox_model.CheckboxValue.True ? checkbox_model.CheckboxValue.False : checkbox_model.CheckboxValue.True;
    }
    handleKeyDown(event) {
    ...
    getInputClassNames = () => ({
        ...
        'ath-checkbox--checked': this.value === checkbox_model.CheckboxValue.True,
        'ath-checkbox--indeterminate': this.value === checkbox_model.CheckboxValue.Indeterminate,
    ...
    getAriaAttributes() {
        ...
        if (this.feedback !== checkbox_model.FeedbackType.None) {
        ...
        return {
            ...
            'aria-invalid': this.feedback === checkbox_model.FeedbackType.Error ? 'true' : undefined,
            'aria-describedby': ariaDescribedBy.join(' '),
            'aria-checked': this.value === checkbox_model.CheckboxValue.Indeterminate ? 'mixed' : this.value,
        };
    }
    getActionAttributes() {
        return {
    ...
    checkValue() {
        if (this.value == checkbox_model.CheckboxValue.True) {
            return checkbox_model.CheckIconValue.Check;
        }
        else if (this.value == checkbox_model.CheckboxValue.Indeterminate) {
            return checkbox_model.CheckIconValue.Indeterminate;
        }
    }
    setInputValue(value) {
        ...
        if (this.elInput) {
            ...
            if (inputValue === checkbox_model.CheckboxValue.True) {
                this.elInput.checked = true;
            }
            else if (inputValue === checkbox_model.CheckboxValue.Indeterminate) {
    ...
    componentWillLoad() {
        if (this.checked)
            this.value = checkbox_model.CheckboxValue.True;
        if (this.indeterminate)
            this.value = checkbox_model.CheckboxValue.Indeterminate;
    }
    componentDidLoad() {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '035b6caa488264c2cf126e7e27cdd3d20c65f974' }, index.h("div", { key: '4b12dc10581f951f1a48f524f72c7568113de4fd', role: "checkbox", class: this.getInputClassNames(), ...actionAttributes, ...ariaAttributes, tabindex: !!this.disabled ? '-1' : '0' }, index.h("div", { key: '6225e34548e7c787c62d36aeaa7baba22e8178bd', class: "ath-checkbox-indicator", id: this.checkboxId, innerHTML: this.checkValue(), tabindex: "-1" }), index.h("div", { key: 'd3ea0dd131ae83ff84df4b409046091a23ed70e5', class: "ath-checkbox__wrapper" }, index.h("input", { key: '448b93492ed9db789e929e6db637f3f006434299', ref: el => (this.elInput = el), type: "hidden", name: this.name, value: this.value, disabled: this.disabled }), !!this.label && index.h(fcLabel.FcInputLabel, { key: '2859a55189d7b805af1aade531a7f5e8e836c09c', ...labelProps }), !!this.helperText && index.h(fcHelper.FcInputHelperText, { key: 'f9ae5357864a75b1c379dceb948703257e59cae3', ...helperTextProps }), this.feedback === 'error' && !this.disabled && !this.readonly && index.h(fcHelper.FcInputFeedback, { key: 'd31347c025980ce41a0b39178ea933a8a6fbf331', ...feedbackProps })))));
    }
...
exports.ath_checkbox = AthCheckBox;
//# sourceMappingURL=ath-checkbox.entry.cjs.js.map
