...
const AthRadioButtonGroup = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '9df73742cad0f46464ad696b4001dfa2e6ce75c0' }, index.h("fieldset", { key: '59e331dffdb0b9642a4dacc7dea97fb536eb703e', class: "ath-radiobutton-group", ...ariaAttributes }, !!this.label && index.h(fcLabel.FcInputLabel, { key: 'c09ca8161b31e04237f91a8bf4254512dfb5b4a1', ...labelProps }), this.showRequired && (index.h("div", { key: 'd570e1f1ada36938dee4a8f40af1991cfad3da8b', id: this.srOnlyId, class: "sr-only" }, this.requiredAriaLabel)), index.h("div", { key: '3159347425a1a5d3268e4042f0a676fc84b6917f', class: this.getGroupClassNames() }, index.h("slot", { key: 'dcb57ddcae288cc6e14991b685891cb0f926c932' })), !!this.helperText && index.h(fcHelper.FcInputHelperText, { key: 'fa404eb0386547b0c30b032f9bff9350a14b2f04', ...helperTextProps }), this.feedback === 'error' && !this.disabled && !this.readonly && index.h(fcHelper.FcInputFeedback, { key: 'd69f81573e0576a6a1a1ad430396d0b8d1f032fb', ...feedbackProps }))));
    }
...
exports.ath_radio_button_group = AthRadioButtonGroup;
//# sourceMappingURL=ath-radio-button-group.entry.cjs.js.map
