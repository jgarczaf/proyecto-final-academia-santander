...
const AthIcon = class {
    ...
    getColor() {
        if (this.color === icon_model.IconColor.Inherit) {
            return undefined;
        }
        return this.color || icon_model.IconColor.Default;
    }
    render() {
        const assetsPath = `assets/images/sprites/${this.theme}/sprites.svg`;
        return (index.h(index.Host, { key: '8bc0985fce43364c5f5a86e2d6d73d41ea9c337d', ...this.getHostAttributes() }, index.h("svg", { key: '1ae8487e6ecc7dfd48ec88973cb07c3321e032eb', width: "1em", height: "1em", focusable: "false", "aria-hidden": "true", class: this.classNames() }, index.h("use", { key: 'ddcd367d6772ae69e8c81e6722328220fed3b8a8', xlinkHref: `${assetsPath}#${this.icon}` }))));
    }
};
AthIcon.style = iconCss;

exports.ath_icon = AthIcon;
//# sourceMappingURL=ath-icon.entry.cjs.js.map
