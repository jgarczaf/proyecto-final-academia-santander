...
const AthButtonExpandable = class {
    ...
    renderIcon = icon => {
        return index.h("ath-icon", { icon: icon, size: icons.transformIconSize(icons.IconType.ButtonExpandable, this.size), color: this.disabled ? 'disabled' : 'default' });
    };
    render() {
        return (index.h(index.Host, { key: 'faaf0dc92d1e94e5c133963373731a0d56074765', class: this.getHostClassNames(), ...this.getAttributes() }, index.h("span", { key: 'ceba8888df59955d0fc3227a473df51e09a636df', class: this.getSpanClassNames() }, this.icon && this.renderIcon(this.icon), index.h("span", { key: '64ecb5be015571bb4d19b4d64cb4a9bc19765ccc', class: "ath-button-expandable--text" }, index.h("slot", { key: '730ca476a633e2c78e268c9541a5c834b74f231b' })), index.h("div", { key: 'b9eb2f5149f7e054f6b12fae1d3bcb726ea65f22', class: this.getChevronClasses() }, this.renderIcon('chevron_up')))));
    }
};
AthButtonExpandable.style = buttonExpandableCss;

exports.ath_button_expandable = AthButtonExpandable;
//# sourceMappingURL=ath-button-expandable.entry.cjs.js.map
