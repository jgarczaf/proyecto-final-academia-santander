...
const AthCalendar = class {
    ...
    handleDaySelect = (_event, day) => {
        ...
        this.shownDate = day;
        this.setAriaLiveMessage(`Fecha seleccionada: ${fcCalendarYear.formatDateToString(day, 'DD/MM/YYYY')}`);
    };
    ...
    render() {
        return (index.h(index.Host, { key: 'be38718b82366d10add964f508474abefed26ac4' }, index.h("div", { key: '455cdfc1511bf324e2df0702bee4522676d1afd3', class: "ath-calendar" }, index.h("div", { key: '276cd27857fcd30759e2132f1f41749a9104f801', "aria-live": "polite", "aria-atomic": "true", class: "sr-only", role: "status" }, this.ariaLiveMessage), index.h("div", { key: 'b37d6e41faf8821ae32d93564f6a35b3d7660e58', class: "ath-calendar__header" }, index.h(fcButtonComp.FcButtonComp, { key: '15d1dde8e554530844100b22f59a1c6bd2f37e82', size: "sm", color: "default", iconPosition: button_model.ButtonIconPosition.IconOnly, icon: "chevron_left", disabled: this.isPrevButtonDisabled(), onClick: this.handlePrevButton, buttonAriaLabel: this.getPrevButtonAriaLabel() }), index.h("div", { key: '7c23ea1cb57218fa4e620ce98149aaaef00b5ef8', class: "ath-calendar__header__date" }, this.showType !== 'year' && (index.h("ath-button", { key: 'ae5ad5261b8adbd0f1e0182c1ecdfa7241286fbb', clear: true, size: "sm", onAthClick: this.handleClickMonth, onKeyDown: e => this.handleKeyDownOverButton(e, 'month'), "aria-label": `Cambiar a vista de selección de mes. Mes seleccionado: ${this.shownDate ? fcCalendarYear.getMonthName(this.shownDate) : this.selectedDate ? fcCalendarYear.getMonthName(this.selectedDate) : fcCalendarYear.getMonthName(new Date())}` }, this.shownDate ? fcCalendarYear.getMonthName(this.shownDate) : this.selectedDate ? fcCalendarYear.getMonthName(this.selectedDate) : fcCalendarYear.getMonthName(new Date()))), index.h("ath-button", { key: 'be78dcfccf08ec652db769b71e0e7e9562f96ec0', clear: true, size: "sm", onAthClick: this.handleClickYear, onKeyDown: e => this.handleKeyDownOverButton(e, 'year'), "aria-label": `Cambiar a vista de selección de año. Año seleccionado: ${this.shownDate ? this.shownDate.getFullYear() : this.selectedDate ? this.selectedDate.getFullYear() : new Date().getFullYear()}` }, this.shownDate ? this.shownDate.getFullYear() : this.selectedDate ? this.selectedDate.getFullYear() : new Date().getFullYear())), index.h(fcButtonComp.FcButtonComp, { key: 'cd1f239ee368386a5a0c23368ce9faee1677ad37', size: "sm", color: "default", iconPosition: button_model.ButtonIconPosition.IconOnly, icon: "chevron_right", disabled: this.isNextButtonDisabled(), onClick: this.handleNextButton, buttonAriaLabel: this.getNextButtonAriaLabel() })), this.showType === 'date' && (index.h("div", { key: '80fcf523b7bd3b99d3462eaf4954337c2d183fb6', class: "ath-calendar__date" }, index.h(fcCalendarYear.FcCalendar, { key: '84826a67549241f786c68c373e8323d2c8135bf6', shownDate: this.shownDate || this.selectedDate || new Date(), selectedDate: this.selectedDate, onDateSelect: this.handleDaySelect, currentDate: new Date(), color: this.color, hasFocus: true, disabledDate: this.disabledDatesAux, highlightedDate: this.highlightedDatesAux, highlightedWeekends: this.highlightedWeekends, minDate: this.minDate, maxDate: this.maxDate, onChangeShownDate: (date) => {
                this.shownDate = date;
            } }))), this.showType === 'month' && (index.h("div", { key: '8f672526e644ecd4548ec951d405c4cf201bb537', class: "ath-calendar__month" }, index.h(fcCalendarYear.FcCalendarMonth, { key: 'ad5243d55695cfe7de18606694be791e79391142', shownMonth: this.shownDate || this.selectedDate || new Date(), selectedMonth: this.selectedDate, onMonthSelect: this.handleMonthSelect, currentMonth: new Date(), color: this.color, hasFocus: true, disabledDates: this.disabledDatesAux, highlightedDates: this.highlightedDatesAux, minMonth: this.minDate, maxMonth: this.maxDate, onChangeShownMonth: (date) => {
                this.shownDate = date;
            } }))), this.showType === 'year' && (index.h("div", { key: 'cf3c3aa61de765ccaa245fe600db427e2c01fe3b', class: "ath-calendar__year" }, index.h(fcCalendarYear.FcCalendarYear, { key: '60b9e85642ca24e697ae7f137c95013f8da8e26d', shownYear: this.shownDate || this.selectedDate || new Date(), selectedYear: this.selectedDate, onYearSelect: this.handleYearSelect, currentYear: new Date(), color: this.color, hasFocus: true, disabledDates: this.disabledDatesAux, highlightedDates: this.highlightedDatesAux, minYear: this.minDate, maxYear: this.maxDate, onChangeShownYear: (date) => {
                this.shownDate = date;
            } }))))));
    }
...
exports.ath_calendar = AthCalendar;
//# sourceMappingURL=ath-calendar.entry.cjs.js.map
