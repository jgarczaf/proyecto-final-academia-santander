...
const AthTabs = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'a491b7cca8c84987cd314aca0a8cbac579a131a2' }, index.h("div", { key: 'eb64d9410cc10310d4ba79bc0089e152b671d7c9', class: this.getHostClassNames() }, this.showLeftArrow && (index.h("div", { key: '1d30f97f7096558f1dd25251de536c4089561c71', class: "ath-tab-header__button ath-tab-header__button-left" }, index.h(fcButtonComp.FcButtonComp, { key: '8a27953c32cdc650041d4639b8433cc39d38ecb6', icon: "chevron_left", color: "default", iconPosition: button_model.ButtonIconPosition.IconOnly, size: icons.IconSize.Small, onClick: () => this.scrollTabs('left'), buttonAriaLabel: "Mostrar m\u00E1s pesta\u00F1as hacia la izquierda" }))), index.h("div", { key: '3e67a1d7b6950b2e858e174a0be4382047d31414', class: "ath-tab__group", ref: el => (this.tabGroup = el), onScroll: () => this.updateArrowsVisibility() }, index.h("ul", { key: 'b5ef42384789a804f316acd883edf7fc9834ba16', role: "tablist", "aria-label": this.listAriaLabel, class: this.getTabListClassNames() }, this.tabs.map(tab => (index.h("li", { role: "presentation", class: this.getTabListClassNames() }, index.h("span", { role: "tab", id: tab.id, "aria-controls": tab.panelId, "aria-selected": tab.id === this.selectedTabId ? 'true' : 'false', "aria-disabled": tab.disabled ? true : false, tabindex: tab.id === this.selectedTabId ? '0' : '-1', class: this.getTabItemClassNames(tab), onClick: () => this.handleTabClick(tab), onKeyUp: event => this.handleKeyUp(event, tab) }, tab.icon && index.h("ath-icon", { icon: tab.icon, size: "md", "aria-label": tab.iconAriaLabel }), tab.label)))))), this.showRightArrow && (index.h("div", { key: '1da92e8803c1fcef119221f39f1fec4fc5afd644', class: "ath-tab-header__button ath-tab-header__button-right" }, index.h(fcButtonComp.FcButtonComp, { key: 'd7a291d54a5e662294efb5c74bd890ab29b91157', icon: "chevron_right", color: "default", iconPosition: button_model.ButtonIconPosition.IconOnly, size: icons.IconSize.Small, onClick: () => this.scrollTabs('right'), buttonAriaLabel: "Mostrar m\u00E1s pesta\u00F1as hacia la derecha" })))), index.h("slot", { key: '5f2250a09f810204c004d22591474e1497ffbb70', name: "panel" })));
    }
...
exports.ath_tabs = AthTabs;
//# sourceMappingURL=ath-tabs.entry.cjs.js.map
