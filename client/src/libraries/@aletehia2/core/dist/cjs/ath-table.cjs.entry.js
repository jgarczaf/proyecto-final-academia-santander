...
const AthTable = class {
    constructor(hostRef) {
        ...
        this.athSelectionChange = index.createEvent(this, "athSelectionChange");
        this.athTableClick = index.createEvent(this, "athTableClick");
    }
    get el() { return index.getElement(this); }
    /** Row height */
    size = table_model.TableSize.Small;
    /** Table color */
    ...
    getSelectAllState() {
        if (!this.rows || this.rows.length === 0) {
            return checkbox_model.CheckboxValue.False;
        }
        ...
        if (selectedCount === 0) {
            ...
            return checkbox_model.CheckboxValue.True;
        }
        else {
            return checkbox_model.CheckboxValue.Indeterminate;
        }
    }
    componentDidLoad() {
    ...
    setColumnFixed = items => {
        if (this.frozen === table_model.TableFrozen.First && items.length > 0) {
            items[0].frozen = this.frozen;
            if (this.selectable !== table_model.TableSelectable.None) {
                items[0].style.left = '60px';
            }
        }
        if (this.frozen === table_model.TableFrozen.Last && items.length > 0) {
    ...
    updateChildrenProps() {
        ...
        this.rows.forEach(row => {
            ...
            if (this.selectable === table_model.TableSelectable.Single) {
            ...
            cells.forEach((cell, index) => {
                ...
                if (this.selectable !== table_model.TableSelectable.None || this.clickable || this.interactiveTable) {
                    cell.role = 'gridcell';
                }
                if (this.color)
        ...
        if (this.headerEl && this.selectable === table_model.TableSelectable.Multiple) {
    ...
    isInteractive() {
        return this.clickable || this.selectable !== table_model.TableSelectable.None || this.interactiveTable;
    }
    getAttributes = () => ({
    ...
    render() {
        return (index.h(index.Host, { key: '036c192ab5f070f5e8f3f56383c17b95c067fba1', ...this.getAttributes(), class: this.getHostClassNames() }, index.h("div", { key: 'af1e8bfecbfa86ee2be4beb4f3629f44ff73a98f', class: "ath-table__header", role: "rowgroup" }, index.h("slot", { key: '3906703c67215d78d2a76e30cb72a5c185db1de1', name: "header" })), index.h("div", { key: 'ecf0ca5b5963e01607cb75a21e71d40af4bf82ee', class: "ath-table__body" }, index.h("slot", { key: '3d017696be65f60fab85f82a92a265f3ac37c6e7', name: "body" })), index.h("div", { key: 'af80677570df37ef91da0e26fe485a9125f103c2', class: "ath-table__footer" }, index.h("slot", { key: '3b4b9c81e21dca325747face982b6d41e6d08e1c', name: "footer" }))));
    }
...
exports.ath_table = AthTable;
//# sourceMappingURL=ath-table.entry.cjs.js.map
