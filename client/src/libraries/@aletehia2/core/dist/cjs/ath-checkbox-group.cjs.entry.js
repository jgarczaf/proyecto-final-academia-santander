...
const AthCheckBoxGroup = class {
    constructor(hostRef) {
        ...
        this.athChecked = index.createEvent(this, "athChecked");
    }
    ...
    initializeSelectedCheckboxes() {
        ...
        checkboxes.forEach(checkbox => {
            ...
            if (value === checkbox_model.CheckboxValue.True) {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '837db2a62381b01cbeca0867b5bb61391d203b52' }, index.h("fieldset", { key: '224a654002e3ece417df960464625133a394c826', class: "ath-checkbox--group", ...ariaAttributes }, !!this.label && index.h(fcLabel.FcInputLabel, { key: '047864d0d2340c2ef34cd164b800523c38f3d6a6', ...labelProps }), this.showRequired && (index.h("div", { key: '0f09d12b13ee9218d20ba44bf5a85052b45702d1', id: this.srOnlyId, class: "sr-only" }, this.requiredAriaLabel)), index.h("div", { key: '81839ee0e8d0a16c22ba6f287fb45c84ad6c2b5c', class: "ath-checkbox--group__items" }, index.h("slot", { key: 'f0cb21b24ea3a93bca190737e25278579692c860' })), this.helperText && index.h(fcHelper.FcInputHelperText, { key: '95b3a6f309db7673080614c2a792b5ada4000098', ...helperTextProps }), this.feedback === 'error' && !this.disabled && !this.readonly && index.h(fcHelper.FcInputFeedback, { key: 'cfdda04d375d2f0349e6972829a8ba606de5baa7', ...feedbackProps }))));
    }
};
AthCheckBoxGroup.style = checkboxGroupCss;

exports.ath_checkbox_group = AthCheckBoxGroup;
//# sourceMappingURL=ath-checkbox-group.entry.cjs.js.map
