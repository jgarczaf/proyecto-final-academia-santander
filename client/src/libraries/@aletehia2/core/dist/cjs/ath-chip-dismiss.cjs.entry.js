...
var chipDismiss_model = require('./chip-dismiss.model-EYQN95KU.js');
...
const AthChipDismiss = class {
    constructor(hostRef) {
        ...
        this.athDismiss = index.createEvent(this, "athDismiss");
    }
     ...
     */
    size = chipDismiss_model.ChipDismissSize.Medium;
    /**
    ...
    renderIcon = () => {
        if (this.icon != 'null') {
            return index.h("ath-icon", { icon: this.icon, size: "xs", color: "inherit" });
        }
    };
    render() {
        return (index.h(index.Host, { key: '4e3bc349a6421e8d151038bb667f64eacaf21a20' }, index.h("span", { key: 'eb3af22c9d93e9fb92182ef129c45f8bb6f40b43', class: this.getSpanClassNames() }, this.icon && this.renderIcon(), index.h("span", { key: 'c503a8c58c655ee4e2fa2e429748339e5206594e', class: "ath-chip-dismiss__text" }, this.headingText), index.h("button", { key: '13f83107525800d78b58302cd2de1705210a3517', "aria-label": this.labelDismiss, disabled: this.disabled, class: "ath-chip-dismiss__button", type: "button", onClick: this.handleDismiss }, index.h("ath-icon", { key: '6c51fc213deedf205c17e3f7e1da4fececa5ea64', icon: "close_small", size: "xs", color: "inherit" })))));
    }
};
AthChipDismiss.style = chipDismissCss;

exports.ath_chip_dismiss = AthChipDismiss;
//# sourceMappingURL=ath-chip-dismiss.entry.cjs.js.map
