...
const AthCardThumbnail = class {
    ...
    renderTag(position) {
        ...
        return index.h("ath-tag", { "heading-text": tagLabel, color: color });
    }
    render() {
        return (index.h(index.Host, { key: '5d93e32ee850d658a18e5f764a7b948340ab2106' }, index.h("div", { key: '0ab1ee4c2ba54472b566167afdcd92779649155e', class: this.getClassNames() }, index.h("div", { key: '2a71d884bf23a0fa50487301d0773f21842ec19f', class: "ath-card-thumbnail_image" }, index.h("slot", { key: 'ff00041a0ad9e09739a1107d3a6987b32e3e61c3', name: "img-thumbnail" })), !!this.topTag && this.type === ThumbnailType.Default && index.h("div", { key: 'ce6995784c3dc4519e097c2074a1c975bcdcb428', class: "ath-card-thumbnail_top-tag" }, this.renderTag('top')), !!this.bottomTag && this.type === ThumbnailType.Default && index.h("div", { key: '64c222bcdb598ee92573e32b41cb2ea8d9a8e79f', class: "ath-card-thumbnail_bottom-tag" }, this.renderTag('bottom')), this.type === ThumbnailType.Highlight && index.h("div", { key: '2b6da865b4902e5fee4aea3c30b0f09c6abc8050', class: "ath-card-thumbnail_highlight" }, this.highlightText), this.type === ThumbnailType.Avatar && (index.h("div", { key: 'bfcc48529b5fe2cc6db2de352a166bc8b4923ff4', class: "ath-card-thumbnail_avatar" }, index.h("slot", { key: '1419a4be7d8671bf7b3af670ce72cb80ae1b7aec', name: "avatar" }))))));
    }
};
AthCardThumbnail.style = cardThumbnailCss;

exports.ath_card_thumbnail = AthCardThumbnail;
//# sourceMappingURL=ath-card-thumbnail.entry.cjs.js.map
