...
const AthDatepicker = class {
        ...
        if (this.value) {
            ...
            switch (this.type) {
                case DatepickerTypes.Year:
                    this.inputValue = this.valueDate ? fcCalendarYear.formatDateToYear(this.valueDate) : '';
                    break;
                case DatepickerTypes.Month:
                    this.inputValue = this.valueDate ? fcCalendarYear.formatDateToMonth(this.valueDate) : '';
                    break;
                default:
                    this.inputValue = this.valueDate ? fcCalendarYear.formatDateToString(this.valueDate, this.format) : '';
                    break;
            }
            if (this.inputEl) {
    ...
    handleDaySelect = (_event, day) => {
        ...
        this.athChange.emit(this.value);
        this.shownDate = day;
        this.inputValue = fcCalendarYear.formatDateToString(day, this.format);
        this.open = false;
        this.wrongDate = false;
        this.feedbackWrong = '';
        this.setAriaLiveMessage(`Fecha seleccionada: ${fcCalendarYear.formatDateToString(day, this.format)}`);
        this.setFocus();
    };
    handleMonthSelect = (_event, month) => {
        if (this.type === DatepickerTypes.Month) {
            ...
            this.inputValue = fcCalendarYear.formatDateToMonth(month);
            this.open = false;
            this.wrongDate = false;
            this.feedbackWrong = '';
            this.setAriaLiveMessage(`Mes seleccionado: ${fcCalendarYear.formatDateToMonth(month)}`);
            this.setFocus();
            return;
        }
    ...
    handleYearSelect = (_event, year) => {
        if (this.type === DatepickerTypes.Year) {
            ...
            this.athChange.emit(this.value);
            this.shownDate = year;
            this.inputValue = fcCalendarYear.formatDateToYear(year);
            this.open = false;
            this.wrongDate = false;
            this.feedbackWrong = '';
            this.setAriaLiveMessage(`Año seleccionado: ${fcCalendarYear.formatDateToYear(year)}`);
            this.setFocus();
            return;
        }
    ...
    handleInputChange = () => {
        ...
        try {
            const result = fcCalendarYear.formatDate(this.inputValue, this.format);
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '60343874e23611b4447d42a5f32cbcec5ffe02d3' }, index.h("div", { key: '38bf1196cad96cc84f41b7188b73b1b4031ef3ec', class: "ath-datepicker", onKeyDown: e => {
                if (e.key === 'Escape') {
                    this.returnInputFocus = true;
                    this.hasFocus = false;
                    setTimeout(() => {
            ...
            } }, index.h("div", { key: '16a173d5e11c1b8bd9fb8022b764fb20d4864694', class: "ath-input", onClick: e => {
                e.preventDefault();
                setTimeout(() => {
                    this.setFocus();
                }, 1);
            } }, !!this.label && index.h(fcLabel.FcInputLabel, { key: 'c85e6c3666f5c3fc333b45507f745454722abe10', ...labelProps }), index.h("div", { key: '01ce76a1003b201aebd63a3d9d58eb40a9814410', class: "wrapper" }, index.h(fcInputElement.FcInputElement, { key: '7e12172f7d159244a85d2427a9e536c63f7579aa', ...inputProps }), !!this.helperText && !this.open && index.h(fcHelper.FcInputHelperText, { key: 'c685842b7d7fe133860911fb7b013e2c6479994e', ...helperTextProps }), index.h("div", { key: '6bc796cf75dc83ef8d40c0e02e41dcd90d54eab5', class: "sr-only", id: this.inputHintSROnlyId }, index.h("span", { key: 'cd03023074464322f913015bf9a3ea6f8778519e' }, fcCalendarYear.getSROnlyHelperText())), ((this.feedback !== DatepickerFeedbacks.None && !this.disabled && !this.readonly && !this.open) || this.wrongDate) && (index.h(fcHelper.FcInputFeedback, { key: '82ffcad21dd0e6ea2a7911a813f8419951902ca7', ...feedbackProps })))), index.h("div", { key: '3f5e5687113574b258b2a25458651c8f2060ddec', "aria-live": "polite", "aria-atomic": "true", class: "sr-only", role: "status" }, this.ariaLiveMessage), this.renderOverlay && (index.h("div", { key: '4d9a5bc12f1c7e12f4ae80e5cb136323a65bf0c1', class: this.getDialogClassNames(), id: this.datepickerpopupId }, index.h("div", { key: '1c6648bebb11d45eadc2a1cd360151132ebbc3e9', class: "ath-datepicker-calendar-date" }, index.h("div", { key: '132d62998cd0013a2c20f603fac8153a1c026d83', class: "ath-datepicker-calendar-date__header" }, index.h(fcButtonComp.FcButtonComp, { key: 'd8545211845d257679023fab565eb1ee75c7f0e5', size: "sm", color: "default", iconPosition: button_model.ButtonIconPosition.IconOnly, icon: "chevron_left", disabled: this.isPrevButtonDisabled(), onClick: this.handlePrevButton, buttonAriaLabel: this.getPrevButtonAriaLabel() }), index.h("div", { key: 'bf1e99bede0886956fd435bc34eb4d0cc7d649d9', class: "ath-datepicker-calendar-date__header__date" }, this.showType !== 'year' && (index.h("ath-button", { key: 'a8ac7d911744d9428514a03d445e961456536c74', clear: true, size: "sm", onAthClick: this.handleClickMonth, onKeyDown: e => this.handleKeyDownOverButton(e, 'month'), "aria-label": `Cambiar a vista de selección de mes. Mes seleccionado: ${this.shownDate ? fcCalendarYear.getMonthName(this.shownDate) : this.valueDate ? fcCalendarYear.getMonthName(this.valueDate) : fcCalendarYear.getMonthName(new Date())}` }, this.shownDate ? fcCalendarYear.getMonthName(this.shownDate) : this.valueDate ? fcCalendarYear.getMonthName(this.valueDate) : fcCalendarYear.getMonthName(new Date()))), index.h("ath-button", { key: '0b4febfe29fc64e72cb98a771bdb0da172bed197', clear: true, size: "sm", onAthClick: this.handleClickYear, onKeyDown: e => this.handleKeyDownOverButton(e, 'year'), "aria-label": `Cambiar a vista de selección de año. Año seleccionado: ${this.shownDate ? this.shownDate.getFullYear() : this.valueDate ? this.valueDate.getFullYear() : new Date().getFullYear()}` }, this.shownDate ? this.shownDate.getFullYear() : this.valueDate ? this.valueDate.getFullYear() : new Date().getFullYear())), index.h(fcButtonComp.FcButtonComp, { key: '9ef9487e6a25ae2c83eaff1a39b25a4d2961f9ff', size: "sm", color: "default", iconPosition: button_model.ButtonIconPosition.IconOnly, icon: "chevron_right", disabled: this.isNextButtonDisabled(), onClick: this.handleNextButton, buttonAriaLabel: this.getNextButtonAriaLabel() })), this.showType === 'date' && (index.h("div", { key: '74a5276f0f9bcddd60ae77ac6e785af3df3e2433', class: "ath-datepicker-calendar-date__date" }, index.h(fcCalendarYear.FcCalendar, { key: '86c3b0ba1913ba546f88978e56cbe95f89e78cda', shownDate: this.shownDate || this.valueDate || new Date(), selectedDate: this.valueDate, hasFocus: this.hasFocus, onDateSelect: this.handleDaySelect, currentDate: new Date(), color: this.color, disabledDate: this.disabledDatesAux, highlightedDate: this.highlightedDatesAux, highlightedWeekends: this.highlightedWeekends, minDate: this.minDate, maxDate: this.maxDate, onChangeShownDate: (date) => {
                this.shownDate = date;
                this.hasFocus = true;
            }, onExit: this.handleOnExit }))), this.showType === 'month' && (index.h("div", { key: '0a1f99e0a50127fd49e04800bc6b26a41692eadf', class: "ath-datepicker-calendar-date__month" }, index.h(fcCalendarYear.FcCalendarMonth, { key: '1999c52136da23a16fe388e9ae90d8bc28d503e1', shownMonth: this.shownDate || this.valueDate || new Date(), selectedMonth: this.valueDate, hasFocus: this.hasFocus, onMonthSelect: this.handleMonthSelect, currentMonth: new Date(), color: this.color, disabledDates: this.disabledDatesAux, highlightedDates: this.highlightedDatesAux, minMonth: this.minDate, maxMonth: this.maxDate, onChangeShownMonth: (date) => {
                this.shownDate = date;
                this.hasFocus = true;
            }, onExit: this.handleOnExit }))), this.showType === 'year' && (index.h("div", { key: 'fc056c8f0dceb444576f4f32430260847d3d035f', class: "ath-datepicker-calendar-date__year" }, index.h(fcCalendarYear.FcCalendarYear, { key: 'a6dbfdff28f6978233617b9300305146710a6107', shownYear: this.shownDate || this.valueDate || new Date(), selectedYear: this.valueDate, hasFocus: this.hasFocus, onYearSelect: this.handleYearSelect, currentYear: new Date(), color: this.color, disabledDates: this.disabledDatesAux, highlightedDates: this.highlightedDatesAux, minYear: this.minDate, maxYear: this.maxDate, onChangeShownYear: (date) => {
                this.shownDate = date;
                this.hasFocus = true;
            }, onExit: this.handleOnExit }))), index.h("div", { key: '37f91da28018c7cc490926e100b91d17e77f9342', class: "ath-datepicker-calendar-date__footer" }, index.h("ath-button", { key: 'bb8fb4ba5551cbff5c6bf7a2cce7f3c663ef4945', clear: true, size: "sm", tabIndex: 0, iconPosition: "left", icon: "reload_double", onAthClick: this.reset }, "Restablecer"))))))));
    }
...
exports.ath_datepicker = AthDatepicker;
//# sourceMappingURL=ath-datepicker.entry.cjs.js.map
