...
const FcDatepickerItem = props => {
    ...
    return (index.h("td", { ref: el => props.onDatepickerItemRef(el), class: getContainerClasses(props), tabIndex: props.isFocusable ? 0 : -1, onClick: handleClick, onKeyDown: props.onKeyDown, "aria-label": getAriaLabel(), "aria-selected": props.isSelected || props.isStart || props.isEnd ? 'true' : 'false', "aria-current": props.isCurrent ? 'date' : undefined, "aria-disabled": props.isDisabled ? 'true' : 'false' }, index.h("span", { class: getItemClasses(props) }, props.text)));
};
...
const FcCalendar = props => {
    ...
    return (index.h("table", { role: "grid", class: "fc-calendar" }, index.h("thead", { class: "fc-calendar__header-week" }, getWeekDaysInitials(props.firstDayOfTheWeek ?? WeekDays.Monday).map(day => (index.h("th", { scope: "col", class: "fc-calendar__header-week__day", "aria-label": getWeekDaysNamesFromInitials(day) }, day)))), index.h("tbody", { class: "fc-calendar__body-week w-full" }, getWeeks(referenceDate, props.firstDayOfTheWeek ?? WeekDays.Monday, 6).map((week) => (index.h("tr", { class: "fc-calendar__row-days" }, week.map(day => (index.h(FcDatepickerItem, { onDatepickerItemRef: el => {
...
const FcCalendarMonth = props => {
    ...
    return (index.h("table", { role: "grid", class: "fc-calendar-month" }, index.h("tbody", { class: "fc-calendar-month__rows" }, getMonths().map((row) => (index.h("tr", { class: "fc-calendar-month__row-months" }, row.map(month => (index.h(FcDatepickerItem, { onDatepickerItemRef: el => {
...
const FcCalendarYear = props => {
    ...
    return (index.h("table", { role: "grid", class: "fc-calendar-year" }, index.h("tbody", { class: "fc-calendar-year__rows" }, getYears().map((row) => (index.h("tr", { class: "fc-calendar-year__row-years" }, row.map(year => (index.h(FcDatepickerItem, { onDatepickerItemRef: el => {
...
exports.FcCalendarMonth = FcCalendarMonth;
exports.FcCalendarYear = FcCalendarYear;
exports.addDays = addDays;
exports.addMonths = addMonths;
exports.addYears = addYears;
exports.formatDate = formatDate;
exports.formatDateToISO = formatDateToISO;
exports.formatDateToMonth = formatDateToMonth;
exports.formatDateToString = formatDateToString;
exports.formatDateToYear = formatDateToYear;
exports.getDateBetweenLimits = getDateBetweenLimits;
exports.getMonthName = getMonthName;
exports.getSROnlyHelperText = getSROnlyHelperText;
exports.getValueRangeString = getValueRangeString;
exports.isDisabledDate = isDisabledDate;
exports.monthStart = monthStart;
exports.yearStart = yearStart;
//# sourceMappingURL=fc-calendar-year-Btiz3_EO.js.map
