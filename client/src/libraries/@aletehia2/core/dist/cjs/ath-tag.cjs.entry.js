...
const AthTag = class {
    ...
    render() {
        return (index.h(index.Host, { key: '1ef4e33816098d44b8912f4ccae5cb7fc99c0c42' }, index.h("div", { key: '3f76640bec0682692ac5a2311b97ca27bef0420e', class: "ath-tag-container" }, index.h("span", { key: '771cbb51a6f4efce149f46b6b7eea940a12f5e5d', class: this.getClassNames() }, this.icon && index.h("ath-icon", { key: '0cfc2ff34ac3a7d23a984586c9364bb178af1364', size: "xs", icon: this.icon, color: "inherit" }), index.h("span", { key: '357c9a59640b8dd9260a994b35c8108cea500745' }, this.headingText ?? index.h("slot", { key: '6a912319c544f571a8320cf7b9aeb5c73f05ae18' }))))));
    }
};
AthTag.style = tagCss;

exports.ath_tag = AthTag;
//# sourceMappingURL=ath-tag.entry.cjs.js.map
