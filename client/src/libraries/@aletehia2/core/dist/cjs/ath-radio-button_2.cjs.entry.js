...
const AthRadioButton = class {
    ...
    renderRadio = () => {
        ...
        return (index.h("div", { class: this.getInputClassNames() }, index.h("span", { tabindex: this.disabled ? -1 : this.tabIndex, ...ariaAttributes, class: "ath-radiobutton-item", id: this.radioButtonId, ...actionAttributes }), !!this.label && (index.h("span", { onClick: this.handleClick }, index.h(fcLabel.FcInputLabel, { ...labelProps })))));
    };
    render() {
        return index.h(index.Host, { key: '649079e1b9c1340f17528c29ae2f39840f86495b' }, " ", this.renderRadio(), " ");
    }
};
...
const AthTableRowItem = class {
    ...
    getClassNames = () => ({
        ...
        [`ath-table-row-item--frozen-${this.frozen}`]: this.frozen !== table_model.TableFrozen.None,
        [`ath-table-row-item--${this.striped ? 'striped--' : ''}frozen-${this.frozen}--shadow`]: this.frozen !== table_model.TableFrozen.None && this.noFrozenShadow !== true,
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '054388d972e82776d2a57a55867457248af15f6e', style: table_utils.getCellStyles(this.cellWidth), class: this.getClassNames(), role: table_utils.getCellRole(this.isHeader) }, showButton && (index.h("button", { key: '720ca0a8ef95d0c050b5b610d0d7e3e303cc0ef5', class: "ath-button_comp", "aria-controls": this.expanderAriaControls, "aria-label": rowEl.expanded ? 'Colapsar fila' : 'Expandir fila', "aria-expanded": String(!!rowEl.expanded), onClick: this.onExpanderClick }, index.h("ath-collapse-icon", { key: '892daf2c7ce9645e36fac844153f986874c74f7b', expanded: rowEl.expanded }))), this.isChild && index.h("div", { key: '79862675aa1a434edbf5f3edeecfcd88e2973764', class: "ath-table-row-item__child-spacing" }), index.h("slot", { key: '7dc7ea3d58ca4087983808289585cc1bcda26ae2' })));
    }
};
AthTableRowItem.style = tableRowItemCss;

exports.ath_radio_button = AthRadioButton;
exports.ath_table_row_item = AthTableRowItem;
//# sourceMappingURL=ath-radio-button.ath-table-row-item.entry.cjs.js.map
