...
const AthProgressBar = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '7acef275ce7084c22220a6ed67524ac6426bce85' }, index.h("div", { key: '66b255d629b835f77472fbbbd5476654a792498e', class: this.getClassNames() }, this.labelLeft && this.labelAlignment === 'inline' && (index.h("span", { key: 'd52255cc6146668622e1a28c8a27b8da929a89b1', id: labelLeftId, class: "ath-progress-bar-label left" }, this.labelLeft)), index.h("div", { key: '62421dcc9455ba73adc3741732fb5c73aabc0ab6', ...this.getHostAtributtes(),
            'aria-labelledby': ariaLabelledBy, class: "ath-progress-bar-item", style: { '--progress-value': `${this.valuePercentage}` } }, index.h("div", { key: 'dea29edcde92aa63e0ba1de6deb03ec576cc71f9', class: this.getFillerClassNames() })), (this.labelLeft || this.labelRight) && this.labelAlignment === 'stack' && (index.h("div", { key: '16a198cea99c3b0c0af93872ef0578ee2bc03d71', class: "ath-progress-bar-temporal" }, this.labelLeft && (index.h("span", { key: 'b6b698676321a5509e9483616bee5b0f520d4a69', id: labelLeftId, class: "ath-progress-bar-label left" }, this.labelLeft)), this.labelRight && (index.h("span", { key: '06db84ee7b9b7da0c91cdc1ec02ac984869ca28f', id: labelRightId, class: "ath-progress-bar-label right" }, this.labelRight)))))));
    }
};
AthProgressBar.style = progressBarCss;

exports.ath_progress_bar = AthProgressBar;
//# sourceMappingURL=ath-progress-bar.entry.cjs.js.map
