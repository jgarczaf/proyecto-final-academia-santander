...
var chipChoice_model = require('./chip-choice.model-Drp5qMgB.js');
...
const AthChipChoice = class {
     ...
     */
    role = chipChoice_model.ChipChoiceRole.Checkbox;
    /**
     * Indica el tamaño del chip (sm/md)
     */
    size = chipChoice_model.ChipChoiceSize.Medium;
    /**
    ...
    isCheckbox() {
        return this.role === chipChoice_model.ChipChoiceRole.Checkbox;
    }
    handleClick = () => {
        this.toogleValueChip();
        this.select();
    ...
    renderIcon = () => {
        return index.h("ath-icon", { icon: this.icon, size: icons.transformIconSize(icons.IconType.Chipchoice, this.size), color: "inherit" });
    };
    render() {
        return (index.h(index.Host, { key: '5969f3fd3f8c0f7136d462f9b683553b836d3145', ...this.getHostAttributes(), class: this.getHostClassNames() }, index.h("span", { key: 'a4c47f1547de3bab87a3d4bc2101748afb2a2d71', class: this.getContainerClassNames() }, !!this.icon && this.renderIcon(), index.h("span", { key: 'f38573a8caf29ce20765b27c94ac15e0ed351e30', class: "ath-chip-choice__text" }, this.label))));
    }
...
exports.ath_chip_choice = AthChipChoice;
//# sourceMappingURL=ath-chip-choice.entry.cjs.js.map
