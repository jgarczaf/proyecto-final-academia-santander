...
const AthCardSelectableGroup = class {
    constructor(hostRef) {
        ...
        this.athValueChanged = index.createEvent(this, "athValueChanged");
    }
    ...
    render() {
        return (index.h(index.Host, { key: '1bac9ae9f2d6b5768851b8a991b5278552e5ae46', role: this.multiple ? 'group' : 'radiogroup' }, index.h("slot", { key: '9de5b15bf60b7757c16d31e97f01c5b7efff528a' })));
    }
};

exports.ath_card_selectable_group = AthCardSelectableGroup;
//# sourceMappingURL=ath-card-selectable-group.entry.cjs.js.map
