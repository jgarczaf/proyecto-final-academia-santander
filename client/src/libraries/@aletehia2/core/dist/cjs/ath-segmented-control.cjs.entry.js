...
const AthSegmentedControl = class {
    constructor(hostRef) {
        ...
        this.athChangeValue = index.createEvent(this, "athChangeValue");
     ...
     */
    feedback = segmentedControl_model.SegmentedControlFeedbackType.None;
    /**
     * Feedback text
     */
    feedbackText;
    ...
    componentDidLoad() {
        ...
        if (this.type === segmentedControl_model.SegmentedControlTypes.Action) {
    ...
    getAriaDescribedBy = () => {
        ...
        if (this.feedback !== segmentedControl_model.SegmentedControlFeedbackType.None) {
    ...
    isActionType() {
        return this.type === segmentedControl_model.SegmentedControlTypes.Action;
    }
    render() {
        ...
        const isActionType = this.type === segmentedControl_model.SegmentedControlTypes.Action;
        return (index.h(index.Host, { key: 'e823ddaf095f5283ac46828174b4d1ff4aabee17' }, index.h("div", { key: 'bbf102e872503262fa9a6b4d876c9d37e7f0a632', ...this.getHostAttributes(), class: "ath-input" }, !isActionType && !!this.label && index.h(fcLabel.FcInputLabel, { key: 'd0c1c31cf60e3813529d6c0839af013fbe3a44e4', ...labelProps }), this.required && !this.hideRequired && (index.h("div", { key: '593f9eb97a7adeadfd09b3f9cf18b53899241896', id: this.requiredLabelId, class: "sr-only" }, this.requiredAriaLabel)), index.h("div", { key: '58b07390ff69473c80f442798c4a99a0e26dca92', class: "wrapper" }, index.h("div", { key: '42aa735aa80b398d794e0927d9eaf35676137eea', class: this.getClassNames() }, index.h("slot", { key: 'ddc73a02d5e61dcde47fd2cfcf27e862ccd35805' })), !isActionType && this.helperText && index.h(fcHelper.FcInputHelperText, { key: '35884c334cf6f115b5cf03bdcd273e9e6e3c860f', ...helperTextProps }), !isActionType && this.feedback === 'error' && !this.disabled && index.h(fcHelper.FcInputFeedback, { key: 'f43727535db0557efd9bd2e637d2e21a267cdc04', ...feedbackProps })))));
    }
...
exports.ath_segmented_control = AthSegmentedControl;
//# sourceMappingURL=ath-segmented-control.entry.cjs.js.map
