...
const AthBadge = class {
    ...
    render() {
        return (index.h(index.Host, { key: '73dc8b6ab27a346db0f4549ecd89ec9bb1eec9a3' }, index.h("div", { key: 'e101aa100ea455a3b7ac4173bf05d7e4e20efad9', class: "ath-badge--container" }, index.h("slot", { key: '9e288c7dc02ebcec7188e0403d5a5f7f25d49185' }), index.h("span", { key: '268174be716b550b501964cbf82b0126e74b4396', class: this.getClassNames(), style: this.getBadgeStyle() }, this.type == 'numeric' && this.getBadgeValue()), index.h("div", { key: 'df4dae3de75825b20816113aaaaabcf19fbbcefb', class: "sr-only" }, this.label))));
    }
...
exports.ath_badge = AthBadge;
//# sourceMappingURL=ath-badge.entry.cjs.js.map
