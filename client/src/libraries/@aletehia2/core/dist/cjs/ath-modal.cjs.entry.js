...
const AthModal = class {
    constructor(hostRef) {
        ...
        this.athOpened = index.createEvent(this, "athOpened");
        this.athClosed = index.createEvent(this, "athClosed");
    }
    ...
    renderHeading = () => {
        ...
        return (index.h(HeadingTitle, { class: "ath-modal-header-text-title", id: "headlineTextId" }, this.headingText));
    };
    renderHeadingSubtitle = () => {
        return (index.h("div", { class: "ath-modal-header-text-subtitle", id: "subtitleTextId" }, this.subtitleText));
    };
    render() {
        if (!this.open) {
            return index.h(index.Host, null);
        }
        return (index.h(index.Host, null, index.h("div", { class: "backdrop", onClick: this.handleBackdropClick }, index.h("div", { ...this.getAccesibilityAttributes(), class: this.getDialogClassNames(), style: this.getDialogStyle() }, index.h("div", { class: this.getHeaderClassNames() }, this.isAlert && index.h(pictograms.FcPictogram, { name: `illu_${this.appearance}_msg` }), index.h("div", { class: "ath-modal-header-text" }, this.headingText && this.renderHeading(), this.subtitleText && this.renderHeadingSubtitle()), this.hasClose && (index.h("div", { class: "ath-modal-header-close" }, index.h(fcButtonComp.FcButtonComp, { icon: "close_small", color: "default", iconPosition: button_model.ButtonIconPosition.IconOnly, size: icons.IconSize.Small, onClick: () => this.closeModal(), buttonAriaLabel: this.closeAriaLabel })))), this.hasDivider && index.h("ath-divider", null), index.h("div", { class: "scrollable-slot ath-scroll" }, index.h("slot", { name: "body" })), index.h("slot", { name: "footer" })))));
    }
};
AthModal.style = modalCss;

exports.ath_modal = AthModal;
//# sourceMappingURL=ath-modal.entry.cjs.js.map
