...
const AthInputText = class {
    constructor(hostRef) {
        ...
        this.athClear = index.createEvent(this, "athClear");
     ...
     */
    type = inputText_model.InputTextTypes.Text;
    /**
     ...
     */
    feedback = inputText_model.InputFeedbackTypes.None;
    /**
     ...
     * The icon position
     */
    iconPosition = inputText_model.InputIconPositions.Left;
    /**
     ...
     */
    size = inputText_model.InputSizes.Medium;
    /**
    ...
    validateType() {
        const validTypes = [inputText_model.InputTextTypes.Text, inputText_model.InputTextTypes.Password, inputText_model.InputTextTypes.Email, inputText_model.InputTextTypes.Url, inputText_model.InputTextTypes.Tel, inputText_model.InputTextTypes.Number, inputText_model.InputTextTypes.Search];
        if (!validTypes.includes(this.inputType)) {
            this.inputType = inputText_model.InputTextTypes.Text;
        }
    }
    updateReadonly() {
        if (this.disabled) {
    ...
    getInputProps = () => ({
        ...
        size: this.size,
        role: this.type === inputText_model.InputTextTypes.Search ? 'searchbox' : undefined,
    ...
    isTypeText = () => this.type === inputText_model.InputTextTypes.Text;
    renderInput = () => {
        ...
        return (index.h("div", { class: "ath-input" }, !!this.label && index.h(fcLabel.FcInputLabel, { ...labelProps }), index.h("div", { class: "wrapper" }, index.h(fcInputElement.FcInputElement, { ...inputProps }), this.isTypeText() && this.counter && index.h(fcCounter.FcInputCounter, { ...counterProps }), !!this.helperText && index.h(fcHelper.FcInputHelperText, { ...helperTextProps }), this.feedback !== inputText_model.InputFeedbackTypes.None && !this.disabled && !this.readonly && index.h(fcHelper.FcInputFeedback, { ...feedbackProps }))));
    };
    render() {
        return index.h(index.Host, { key: '8f9e8e31de73407ac9cd67df877efe7167e5f965' }, this.renderInput());
    }
...
exports.ath_input_text = AthInputText;
//# sourceMappingURL=ath-input-text.entry.cjs.js.map
