...
const AthText = class {
    ...
    render() {
        ...
        const textContent = this.content ?? index.h("slot", { key: '663a7aacb26dedc2fff066e33bb301bee2aafe59' });
        ...
        const textElement = (index.h(Tag, { key: '1c242d0642326705533f3ef5f17477b52934a042', class: {
                ...this.getClassNames(),
        ...
        const content = shouldShowTooltip ? (index.h("ath-tooltip", { headingText: tooltipText, position: "bottom", trigger: "hover", maxWidth: 750 }, textElement)) : (textElement);
        return (index.h(index.Host, { key: 'f6b96440f40aeb9c3f99afeac8987ec4f75ec43c' }, index.h("div", { key: '68978d5aa5fd1f4df7f144ac8224ad224d11913c', class: "ath-text-container" }, content)));
    }
...
exports.ath_text = AthText;
//# sourceMappingURL=ath-text.entry.cjs.js.map
