...
const AthAccordionItem = class {
    ...
    render() {
        return (index.h(index.Host, { key: '68046b3579d868429680fa8b88d95889cab97ff1' }, index.h("div", { key: '2f4945ca774128a3bb1bb75ef858f59cfdf6a92c', class: this.getParentClassNames() }, index.h("div", { key: 'a37518c1536834a9b98a481023af4b1eb450d1d9', role: "button", "aria-expanded": this.expanded ? 'true' : 'false', "aria-controls": this.panelId, "aria-disabled": this.disabled ? 'true' : 'false', tabindex: this.disabled ? '-1' : '0', onClick: () => this.handleToggle(), onKeyDown: event => this.handleKeydown(event), class: this.getHeaderClassNames() }, index.h("span", { key: 'b1bd2a4986485e331b417106f0c11f80aaea8d75', id: this.hostId, class: `ath-accordion-item--header__button`, role: "heading", "aria-level": this.headingLevel }, index.h("div", { key: 'e63c41426a534ac2b89f99a2196a2cd887758f7f', class: "ath-accordion-item--header__wrapper" }, index.h("div", { key: 'd432b26354dab48dc59bdc5579892b995ba88d6d', class: "ath-accordion-item--header__content" }, this.icon && index.h("ath-icon", { key: '9c972ccb46b96d4a0cba41c4aabdec7527cf874b', icon: this.icon }), index.h("div", { key: 'e1a9d0f175342206802fa40e217d311d1f78f221', class: "ath-accordion-item--header__text" }, this.headingText && index.h("span", { key: '6df9e776aad70740bd3c16a692957ef3216d4e3e', class: "ath-accordion-item--header__title" }, this.headingText), this.description && index.h("span", { key: 'cd6684b9c5a1dc904dfb676510b8335654cb9a80', class: "ath-accordion-item--header__subtitle" }, this.description))), index.h("slot", { key: '2be30b5d415d7b5dbbb2d796c2fe6e7aff81aca0', name: "header-detail" }), index.h("div", { key: '87c03dc120f04234c288840d8c2c94e1b22198c3', class: this.getChevronClasses() }, index.h("ath-icon", { key: '8de9485de25b812b3ac64fd360dfafc8db61b62b', icon: "chevron_down" }))))), index.h("div", { key: 'a59a2d0803d4020e6f731e0977dd4b35ae5cb1d8', id: this.panelId, class: this.getPanelClassNames() }, index.h("slot", { key: '38c4b3d0b657e635341d17e5213d545504e90cfc' })))));
    }
...
exports.ath_accordion_item = AthAccordionItem;
//# sourceMappingURL=ath-accordion-item.entry.cjs.js.map
