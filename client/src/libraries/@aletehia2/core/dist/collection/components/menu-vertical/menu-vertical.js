...
import { MenuVerticalAppearances } from "./menu-vertical.model";
let menuVerticalSequence = 0;
export class AthMenuVertical {
    ...
    static get is() { return "ath-menu-vertical"; }
    ...
    static get properties() {
        return {
            "appearance": {
                ...
                "mutable": false,
                "complexType": {
                    "original": "MenuVerticalAppearance",
                    "resolved": "\"primary\" | \"secondary\"",
                    "references": {
                        "MenuVerticalAppearance": {
                            "location": "import",
                            "path": "./menu-vertical.model",
                            "id": "src/components/menu-vertical/menu-vertical.model.ts::MenuVerticalAppearance"
                        }
                    }
                },
                "required": false,
                ...
                "docs": {
                    "tags": [],
                    "text": "Appearance of the menu"
                },
                "getter": false,
                "setter": false,
                "reflect": false,
                "defaultValue": "MenuVerticalAppearances.Primary"
            }
        };
    }
    static get states() {
    ...
    static get events() {
        return [{
                ...
                "docs": {
                    "tags": [],
                    "text": "Emitted when link or action Button is clicked"
                },
                "complexType": {
                    "original": "MenuItem",
                    "resolved": "MenuItemBase & { tagName: \"ath-MENU-VERTICAL-ITEM-ACTION\"; } | MenuItemBase & { tagName: \"ath-MENU-VERTICAL-ITEM-LINK\"; href?: string; target?: \"top\" | \"self\" | \"parent\" | \"blank\"; rel?: string; externalLabel?: string; }",
                    "references": {
                        "MenuItem": {
                            "location": "import",
                            "path": "./stories/menu-vertical.types",
                            "id": "src/components/menu-vertical/stories/menu-vertical.types.ts::MenuItem"
                        }
                    }
                }
            }];
