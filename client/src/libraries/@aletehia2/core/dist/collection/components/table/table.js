...
import { TableSize, TableColor, TableStriping, TableFrozen, TableSelectable, } from "./table.model";
...
export class AthTable {
    ...
    static get is() { return "ath-table"; }
    ...
    static get properties() {
        return {
            ...
            "frozen": {
                ...
                "docs": {
                    "tags": [],
                    "text": "Fix the first or last column"
                },
                "getter": false,
                "setter": false,
                "reflect": false
    ...
    static get events() {
        return [{
                "method": "athSelectionChange",
                "name": "athSelectionChange",
                "bubbles": true,
                "cancelable": true,
                "composed": true,
                "docs": {
                    "tags": [],
                    "text": "Fired whenever row selection changes"
                },
                "complexType": {
                    "original": "TableSelectionChangeEvent",
                    "resolved": "{ selectedIndexes: number[]; selectedValues: any[]; }",
                    "references": {
                        "TableSelectionChangeEvent": {
                            "location": "import",
                            "path": "./table.model",
                            "id": "src/components/table/table.model.ts::TableSelectionChangeEvent"
                        }
                    }
                }
            }, {
                "method": "athTableClick",
                "name": "athTableClick",
                "bubbles": true,
                "cancelable": true,
                "composed": true,
                "docs": {
                    "tags": [],
                    "text": "Fired when a clickable row is clicked"
                },
                "complexType": {
                    "original": "TableClickEvent",
                    "resolved": "{ rowIndex: number; rowValue: any; rowId?: string; }",
                    "references": {
                        "TableClickEvent": {
                            "location": "import",
                            "path": "./table.model",
                            "id": "src/components/table/table.model.ts::TableClickEvent"
                        }
                    }
                }
            }];
    ...
    static get methods() {
        return {
            "refresh": {
                ...
                "docs": {
                    "text": "Refresh the table. Useful when dynamically changing content",
                    "tags": []
                }
            }
        };
    ...
    static get watchers() {
        return [{
                ...
                "propName": "clickable",
                "methodName": "handleClickableChange"
            }];
    }
    static get listeners() {
        return [{
                "name": "athToggleCollapse",
                "method": "handleCollapseToggle",
                "target": "window",
                "capture": false,
                "passive": false
            }, {
                "name": "athSelectAllChange",
                "method": "handleSelectAllChange",
                "target": undefined,
                "capture": false,
                "passive": false
            }];
