...
export class AthChipChoiceGroup {
    el;
    internals;
    /**
    ...
    static get is() { return "ath-chip-choice-group"; }
    static get encapsulation() { return "shadow"; }
    static get formAssociated() { return true; }
    static get originalStyleUrls() {
        return {
            "$": ["chip-choice-group.scss"]
        };
    }
    static get styleUrls() {
        return {
            "$": ["chip-choice-group.css"]
        };
    }
    static get properties() {
        return {
            ...
            "multiple": {
                ...
                "docs": {
                    "tags": [],
                    "text": "Allow multiple selection of chips"
                },
                "getter": false,
                "setter": false,
                "reflect": false,
            ...
            "name": {
                ...
                "docs": {
                    "tags": [],
                    "text": "The generic name for the chips"
                },
                "getter": false,
                "setter": false,
                "reflect": false
            ...
            "value": {
                ...
                "docs": {
                    "tags": [],
                    "text": "The value for not multiple (use chip-choice-group as radio-group)"
                },
                "getter": false,
                "setter": false,
                "reflect": false
    ...
    static get events() {
        return [{
                ...
                "docs": {
                    "tags": [],
                    "text": "Event to emit the current chips checked"
                },
                "complexType": {
                    "original": "HTMLAthChipChoiceElement[]",
                    "resolved": "HTMLAthChipChoiceElement[]",
                    "references": {
                        "HTMLAthChipChoiceElement": {
                            "location": "global",
                            "id": "global::HTMLAthChipChoiceElement"
                        }
                    }
                }
            }];
...
//# sourceMappingURL=chip-choice-group.js.map
