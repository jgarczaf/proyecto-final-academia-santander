...
import { d as attrBoolean, e as attrString, f as attrNumber, a as InputFeedbackTypes$1 } from './p-BV9c4BOf.js';
...
const getInputTextareaAttributes = (props) => {
    ...
    return {
        ...
        'aria-invalid': attrBoolean(props.feedback === InputFeedbackTypes$1.Error, false),
...
const AthInputTextarea$1 = /*@__PURE__*/ proxyCustomElement(class AthInputTextarea extends H {
...
function defineCustomElement$1() {
    ...
    const components = ["ath-input-textarea"];
    components.forEach(tagName => { switch (tagName) {
        case "ath-input-textarea":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, AthInputTextarea$1);
            }
            break;
    } });
}

const AthInputTextarea = AthInputTextarea$1;
const defineCustomElement = defineCustomElement$1;

export { AthInputTextarea, defineCustomElement };
//# sourceMappingURL=ath-input-textarea.js.map
