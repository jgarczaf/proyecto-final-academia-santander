...
const AthSwitch$1 = /*@__PURE__*/ proxyCustomElement(class AthSwitch extends H {
...
function defineCustomElement$1() {
    ...
    const components = ["ath-switch"];
    components.forEach(tagName => { switch (tagName) {
        case "ath-switch":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, AthSwitch$1);
            }
            break;
    } });
}

const AthSwitch = AthSwitch$1;
const defineCustomElement = defineCustomElement$1;

export { AthSwitch, defineCustomElement };
//# sourceMappingURL=ath-switch.js.map
