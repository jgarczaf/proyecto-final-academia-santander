...
const AthInputPassword$1 = /*@__PURE__*/ proxyCustomElement(class AthInputPassword extends H {
    ...
    static get style() { return inputPasswordCss; }
        ...
        "labelShowPassword": [1, "label-show-password"],
        "labelHidePassword": [1, "label-hide-password"],
        "value": [1025],
        "showPassword": [32],
        "setFocus": [64]
    }, undefined, {
...
function defineCustomElement$1() {
    ...
    const components = ["ath-input-password"];
    components.forEach(tagName => { switch (tagName) {
        case "ath-input-password":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, AthInputPassword$1);
            }
            break;
    } });
}

const AthInputPassword = AthInputPassword$1;
const defineCustomElement = defineCustomElement$1;

export { AthInputPassword, defineCustomElement };
//# sourceMappingURL=ath-input-password.js.map
