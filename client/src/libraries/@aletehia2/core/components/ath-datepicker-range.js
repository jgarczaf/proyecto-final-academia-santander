...
const AthDatepickerRange$1 = /*@__PURE__*/ proxyCustomElement(class AthDatepickerRange extends H {
    ...
    static get style() { return datepickerRangeCss; }
}, [321, "ath-datepicker-range", {
        "label": [1],
        ...
        "format": [1],
        "placeholderStart": [1, "placeholder-start"],
        "placeholderEnd": [1, "placeholder-end"],
        "name": [1],
        "required": [4],
        "requiredStart": [4, "required-start"],
        "requiredEnd": [4, "required-end"],
        ...
        "type": [1],
        "color": [1],
        "inputAriaLabelStart": [1, "input-aria-label-start"],
        "inputAriaLabelEnd": [1, "input-aria-label-end"],
...
function defineCustomElement$1() {
    ...
    const components = ["ath-datepicker-range", "ath-button", "ath-button-link", "ath-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "ath-datepicker-range":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, AthDatepickerRange$1);
            }
            break;
        case "ath-button":
            if (!customElements.get(tagName)) {
...
const AthDatepickerRange = AthDatepickerRange$1;
const defineCustomElement = defineCustomElement$1;

export { AthDatepickerRange, defineCustomElement };
//# sourceMappingURL=ath-datepicker-range.js.map
