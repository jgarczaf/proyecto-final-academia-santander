...
import { d as defineCustomElement$5 } from './p-DbpanEQL.js';
import { d as defineCustomElement$4 } from './p-Dk4WCCHh.js';
...
const AthMenuVertical$1 = /*@__PURE__*/ proxyCustomElement(class AthMenuVertical extends H {
    ...
    static get style() { return menuVerticalCss; }
}, [257, "ath-menu-vertical", {
        "appearance": [1],
        "menuItems": [32],
        "focusedItemId": [32]
    }]);
function defineCustomElement$1() {
    ...
    const components = ["ath-menu-vertical", "ath-icon", "ath-section-title", "ath-tooltip", "ath-tooltip-trigger"];
    components.forEach(tagName => { switch (tagName) {
        case "ath-menu-vertical":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, AthMenuVertical$1);
            }
            break;
        case "ath-icon":
            if (!customElements.get(tagName)) {
...
const AthMenuVertical = AthMenuVertical$1;
const defineCustomElement = defineCustomElement$1;

export { AthMenuVertical, defineCustomElement };
//# sourceMappingURL=ath-menu-vertical.js.map
