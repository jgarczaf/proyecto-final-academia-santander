...
import { f as formatDateToString, g as getDateBetweenLimits, a as formatDateToMonth, b as formatDateToYear, c as addYears, d as addMonths, e as getMonthName, i as isDisabledDate, y as yearStart, m as monthStart, F as FcCalendar, h as FcCalendarMonth, j as FcCalendarYear } from './p-mD313d-b.js';
...
const AthCalendar$1 = /*@__PURE__*/ proxyCustomElement(class AthCalendar extends H {
...
function defineCustomElement$1() {
    ...
    const components = ["ath-calendar", "ath-button", "ath-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "ath-calendar":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, AthCalendar$1);
            }
            break;
        case "ath-button":
            if (!customElements.get(tagName)) {
...
const AthCalendar = AthCalendar$1;
const defineCustomElement = defineCustomElement$1;

export { AthCalendar, defineCustomElement };
//# sourceMappingURL=ath-calendar.js.map
