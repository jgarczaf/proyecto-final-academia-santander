...
const AthText$1 = /*@__PURE__*/ proxyCustomElement(class AthText extends H {
...
function defineCustomElement$1() {
    ...
    const components = ["ath-text", "ath-tooltip"];
    components.forEach(tagName => { switch (tagName) {
        case "ath-text":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, AthText$1);
            }
            break;
        case "ath-tooltip":
            if (!customElements.get(tagName)) {
...
const AthText = AthText$1;
const defineCustomElement = defineCustomElement$1;

export { AthText, defineCustomElement };
//# sourceMappingURL=ath-text.js.map
