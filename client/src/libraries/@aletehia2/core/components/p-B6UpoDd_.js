...
const AthProgressBar = /*@__PURE__*/ proxyCustomElement(class AthProgressBar extends H {
...
}, [257, "ath-progress-bar", {
        "infinite": [4],
        "labelLeft": [1, "label-left"],
        "labelRight": [1, "label-right"],
        "labelAlignment": [1, "label-alignment"],
        "min": [2],
        "max": [2],
        "value": [2],
...
function defineCustomElement() {
    ...
    const components = ["ath-progress-bar"];
    components.forEach(tagName => { switch (tagName) {
        case "ath-progress-bar":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, AthProgressBar);
            }
            break;
    } });
}

export { AthProgressBar as A, defineCustomElement as d };
//# sourceMappingURL=p-B6UpoDd_.js.map
