...
import { d as defineCustomElement$2 } from './p-DdZEtBOc.js';
...
const AthInputCounter = /*@__PURE__*/ proxyCustomElement(class AthInputCounter extends H {
    ...
    static get style() { return inputCounterCss; }
}, [321, "ath-input-counter", {
        ...
        "unit": [1],
        "unitAriaLabel": [1, "unit-aria-label"],
        "value": [1025]
    }, undefined, {
        "disabled": ["watchDisabled"],
        "value": ["updateValue"]
...
function defineCustomElement() {
    ...
    const components = ["ath-input-counter", "ath-button", "ath-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "ath-input-counter":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, AthInputCounter);
            }
            break;
        case "ath-button":
            if (!customElements.get(tagName)) {
...
export { AthInputCounter as A, defineCustomElement as d };
//# sourceMappingURL=p-DXo_abWa.js.map
