...
import { c as TableSelectable, a as TableColor, d as TableFrozen } from './p-DH9nlGTF.js';
import { C as CheckboxValue } from './p-DynFLFRk.js';
import { d as defineCustomElement$3 } from './p-Bw6_WJxi.js';
import { d as defineCustomElement$2 } from './p-C2NJclr2.js';
...
const AthTableHeader$1 = /*@__PURE__*/ proxyCustomElement(class AthTableHeader extends H {
...
}, [257, "ath-table-header", {
        "selectable": [1],
        "clickable": [4],
        "color": [1],
        "size": [1],
        "frozen": [1],
        "noSelectAll": [4, "no-select-all"],
        "selectAllState": [1, "select-all-state"],
        "totalRows": [2, "total-rows"],
        "selectedRows": [2, "selected-rows"]
    }]);
function defineCustomElement$1() {
    if (typeof customElements === "undefined") {
        return;
    }
    const components = ["ath-table-header", "ath-checkbox", "ath-table-header-item"];
    components.forEach(tagName => { switch (tagName) {
        case "ath-table-header":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, AthTableHeader$1);
            }
            break;
        case "ath-checkbox":
            if (!customElements.get(tagName)) {
...
const AthTableHeader = AthTableHeader$1;
const defineCustomElement = defineCustomElement$1;

export { AthTableHeader, defineCustomElement };
//# sourceMappingURL=ath-table-header.js.map
