...
import { d as defineCustomElement$2 } from './p-BhtV36-z.js';
...
const AthModal$1 = /*@__PURE__*/ proxyCustomElement(class AthModal extends H {
            ...
            if (node instanceof H) {
                ...
                if (shadow) {
                    shadow.querySelectorAll(focusableSelector).forEach(el => {
                        if (el instanceof H && window.getComputedStyle(el).display !== 'none') {
                            results.add(el);
                        }
                    });
                }
...
function defineCustomElement$1() {
    ...
    const components = ["ath-modal", "ath-divider"];
    components.forEach(tagName => { switch (tagName) {
        case "ath-modal":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, AthModal$1);
            }
            break;
        case "ath-divider":
            if (!customElements.get(tagName)) {
...
const AthModal = AthModal$1;
const defineCustomElement = defineCustomElement$1;

export { AthModal, defineCustomElement };
//# sourceMappingURL=ath-modal.js.map
