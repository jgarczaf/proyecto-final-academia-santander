...
const AthTag = /*@__PURE__*/ proxyCustomElement(class AthTag extends H {
...
function defineCustomElement() {
    ...
    const components = ["ath-tag", "ath-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "ath-tag":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, AthTag);
            }
            break;
        case "ath-icon":
            if (!customElements.get(tagName)) {
...
export { AthTag as A, defineCustomElement as d };
//# sourceMappingURL=p-B4i4aRdS.js.map
