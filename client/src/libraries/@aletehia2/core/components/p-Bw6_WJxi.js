...
import { C as CheckboxValue, F as FeedbackType, a as CheckIconValue } from './p-DynFLFRk.js';
...
const AthCheckBox = /*@__PURE__*/ proxyCustomElement(class AthCheckBox extends H {
...
function defineCustomElement() {
    ...
    const components = ["ath-checkbox"];
    components.forEach(tagName => { switch (tagName) {
        case "ath-checkbox":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, AthCheckBox);
            }
            break;
    } });
}

export { AthCheckBox as A, defineCustomElement as d };
//# sourceMappingURL=p-Bw6_WJxi.js.map
