...
import { d as defineCustomElement$2 } from './p-CZx96Pxl.js';
...
const AthMenuHorizontal$1 = /*@__PURE__*/ proxyCustomElement(class AthMenuHorizontal extends H {
    ...
    static get style() { return menuHorizontalCss; }
}, [258, "ath-menu-horizontal", {
        "athAriaLabel": [1, "ath-aria-label"],
        "hasDivider": [4, "has-divider"],
        "items": [1],
        "selectedMenuHorizontalItemId": [32],
        "activeMenuHorizontalItemId": [32],
        "showArrows": [32],
        "isLeftArrowHidden": [32],
        "isRightArrowHidden": [32]
    }, undefined, {
        "items": ["onItemsChange"]
    }]);
function defineCustomElement$1() {
    ...
    const components = ["ath-menu-horizontal", "ath-badge"];
    components.forEach(tagName => { switch (tagName) {
        case "ath-menu-horizontal":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, AthMenuHorizontal$1);
            }
            break;
        case "ath-badge":
            if (!customElements.get(tagName)) {
...
const AthMenuHorizontal = AthMenuHorizontal$1;
const defineCustomElement = defineCustomElement$1;

export { AthMenuHorizontal, defineCustomElement };
//# sourceMappingURL=ath-menu-horizontal.js.map
