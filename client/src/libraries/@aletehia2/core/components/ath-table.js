...
import { T as TableSize, a as TableColor, b as TableStriping, c as TableSelectable, d as TableFrozen } from './p-DH9nlGTF.js';
import { C as CheckboxValue } from './p-DynFLFRk.js';
import { d as defineCustomElement$2 } from './p-DHqkcaR2.js';
...
const AthTable$1 = /*@__PURE__*/ proxyCustomElement(class AthTable extends H {
    ...
    static get style() { return tableCss; }
        ...
        "refresh": [64]
    }, [[8, "athToggleCollapse", "handleCollapseToggle"], [0, "athSelectAllChange", "handleSelectAllChange"]], {
        "selectable": ["handleSelectableChange"],
        "clickable": ["handleClickableChange"]
    }]);
function defineCustomElement$1() {
    ...
    const components = ["ath-table", "ath-collapse"];
    components.forEach(tagName => { switch (tagName) {
        case "ath-table":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, AthTable$1);
            }
            break;
        case "ath-collapse":
            if (!customElements.get(tagName)) {
...
const AthTable = AthTable$1;
const defineCustomElement = defineCustomElement$1;

export { AthTable, defineCustomElement };
//# sourceMappingURL=ath-table.js.map
