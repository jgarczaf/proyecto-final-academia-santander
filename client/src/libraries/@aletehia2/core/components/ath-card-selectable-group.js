...
const AthCardSelectableGroup$1 = /*@__PURE__*/ proxyCustomElement(class AthCardSelectableGroup extends H {
...
}, [260, "ath-card-selectable-group", {
        "disabled": [4],
        "multiple": [4],
        "size": [1]
    }, [[0, "keydown", "handleKeyDown"], [0, "athChange", "handleChange"]]]);
function defineCustomElement$1() {
    if (typeof customElements === "undefined") {
        return;
    }
    const components = ["ath-card-selectable-group"];
    components.forEach(tagName => { switch (tagName) {
        case "ath-card-selectable-group":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, AthCardSelectableGroup$1);
            }
            break;
    } });
}

const AthCardSelectableGroup = AthCardSelectableGroup$1;
const defineCustomElement = defineCustomElement$1;

export { AthCardSelectableGroup, defineCustomElement };
//# sourceMappingURL=ath-card-selectable-group.js.map
